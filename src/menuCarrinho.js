import { catalogo, salvarEmLocalStorage, lerLocalStorage } from './utilidades';
...
function incrementarQuantidadeProduto(idProduto) {
     ...
     salvarEmLocalStorage('carrinho', idsProdutoCarrinhoComQuantidade);
...
function desenharProdutoNoCarrinho(idProduto) {
   ...
   const cartaoProdutoCarrinho = `<button id='remover-item-${produto.id}' class='absolute right-2 top-0'>
     ...
     <div class='p-2 flex flex-col justify-between'>
       ...
       <p class='text-slate-400 text-xs'>Tamnho: M</p>
